    ...
    $("studentTableBody").innerHTML = slice.map((s,i) => `
      <tr>
        ...
        <td>
          ...
          <div class="muted">NIK: ${esc(s.nik || "-")}</div>
        </td>
        <td>${esc(s.gender || "-")}</td>
      ...
      <article class="student-card">
        <div class="top">
          <div>
            ...
            <p>${esc(s.nis || "NIS belum diisi")} · ${esc(s.nisn || "NISN belum diisi")}<br>NIK: ${esc(s.nik || "-")}</p>
          </div>
...
function openEdit(id) {
  ...
  $("kipPipNumber").value = s.kip_pip_number || "";
  $("specialNeeds").value = s.special_needs || "";
  $("disability").value = s.disability || "";
...
async function saveStudent(e) {
  ...
  const payload = {
    ...
    kip_pip_number: $("kipPipNumber").value.trim() || null,
    special_needs: $("specialNeeds").value.trim() || null,
    disability: $("disability").value.trim() || null,
